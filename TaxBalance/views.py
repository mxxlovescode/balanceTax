"""API для анализа Операция по расчету с бюджетом УФНС

Основной интерфейс UFNSView. Его достаточно инициализировать.
"""
...
class UFNSInsurancePaymentsValidated:
    ...
    В ней руками занесены по каждому кварталу решения о взыскании, сколько по нашим данным оплачено и сколько по
    нашему отчету
    """
